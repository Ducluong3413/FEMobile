...
class _HomeLoginState extends State<HomeLogin> {
  ...
  int _failedAttempts = 0; // Đếm số lần đăng nhập sai
  ...
  void _handleLogin() async {
    ...
    bool loginSuccess = await loginController.login(context);
  ...
  void _showForgotPasswordDialog() {
    showDialog(
      ...
      builder:
          (context) => AlertDialog(
            title: const Text("Bạn có quên mật khẩu?"),
            content: const Text(
              "Bạn đã nhập sai 3 lần. Hãy thử lại hoặc đặt lại mật khẩu.",
            ),
            actions: [
              TextButton(
                onPressed: () {
